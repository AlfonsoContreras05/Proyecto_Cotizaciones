    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
            <div className="container-fluid">
                ...
                <section className="offcanvas offcanvas-start" id="menuLateral" tabIndex="-1"/>
                    ...
                    <div className="offcanvas-body d-flex flex-column justify-content-between px-0 bg-dark">
                        <ul className="navbar-nav fs-6 justify-content-evenly">
                            ...
                            <li className="nav-item p-3 py-md-1">
                             <Link to="/" className="nav-link">CREAR COTIZACION <img src={imageM} alt="mas" width="15" height="15"/> </Link>
                            </li>
                            <li className="nav-item p-3 py-md-1">
                                <Link to="/" className="nav-link">HISTORIAL</Link>
                            </li>
                            <li className="nav-item p-3 py-md-1">
                                <Link to="/" className="nav-link">TOTALIZADOS</Link>
                            </li>
                            <li className="nav-item p-3 py-md-1">
